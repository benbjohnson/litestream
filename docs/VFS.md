...
- `litestream_current_time()`: returns the active target time or the timestamp of the latest available LTX file (RFC3339Nano). Returns `latest` only before any LTX files have been loaded.
