...
type ReplicaClient struct {
	...
	LTXFilesFunc       func(ctx context.Context, level int) (litestream.LTXFileIterator, error)
	OpenLTXFileFunc    func(ctx context.Context, level int, minTXID, maxTXID ltx.TXID) (io.ReadCloser, error)
	WriteLTXFileFunc   func(ctx context.Context, level int, minTXID, maxTXID ltx.TXID, r io.Reader) (*litestream.LTXFileInfo, error)
	DeleteLTXFilesFunc func(ctx context.Context, a []*litestream.LTXFileInfo) error
}
...
func (c *ReplicaClient) WriteLTXFile(ctx context.Context, level int, minTXID, maxTXID ltx.TXID, r io.Reader) (*litestream.LTXFileInfo, error) {
